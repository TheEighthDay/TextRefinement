...
def train_epoch(epoch, args, model, train_dataloader, device, n_gpu, optimizer, scheduler, global_step, local_rank=0):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        if args.multi_augmentation:
            ...
            loss = model(multi_input_ids, multi_segment_ids, multi_input_mask, video, video_mask,multi_augmentation=True)
        else:
            input_ids, input_mask, segment_ids, video, video_mask = batch
            loss = model(input_ids, segment_ids, input_mask, video, video_mask,multi_augmentation=False)
